...
class FieldElement:
    ...
    def __truediv__(self, other):
        ...
        # OR num = self.num * pow(other.num, -1 , self.prime) % self.prime
        return self.__class__(num, self.prime)
...
class Point:
    def __init__(self, x, y, a, b):
        ...
        if pow(self.y,2) != pow(self.x,3) + self.a * self.x + self.b:
    ...
    def __add__(self, other):
        ...
        # Result is point at infinity => x, y = None
        ...
        # Case 3: self == other # tangent case - 2 points are the same
